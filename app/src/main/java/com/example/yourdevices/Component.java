...
public class Component {
    ...
    public Component(int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, String n1, String n2, String n3, String n4, String n5, String n6, String n7, String n8) {
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
        this.i4 = i4;
